...
class Dc_MercadoPagoPlus_MercadoPago {
    ...
    public function get_access_token() {
        ...
        $access_data = Dc_MercadoPagoPlus_Client::post("/oauth/token", $app_client_values, "application/x-www-form-urlencoded");
    ...
    public function refund_payment($id) {
        ...
        $response = Dc_MercadoPagoPlus_Client::put("/collections/" . $id . "?access_token=" . $access_token, $refund_status);
        return $response;
    }
    ...
    public function cancel_payment($id) {
        ...
        $response = Dc_MercadoPagoPlus_Client::put("/collections/" . $id . "?access_token=" . $access_token, $cancel_status);
        return $response;
    }
    ...
    public function cancel_preapproval_payment($id) {
        ...
        $response = Dc_MercadoPagoPlus_Client::put("/preapproval/" . $id . "?access_token=" . $access_token, $cancel_status);
        return $response;
    }
    ...
    public function search_payment($filters, $offset = 0, $limit = 0) {
        ...
        $collection_result = Dc_MercadoPagoPlus_Client::get($uri_prefix."/collections/search?" . $filters . "&access_token=" . $access_token);
    ...
    public function get($uri, $params = null, $authenticate = true) {
        ...
        $result = Dc_MercadoPagoPlus_Client::get($uri);
        return $result;
    }
    ...
    public function post($uri, $data, $params = null) {
        ...
        $result = Dc_MercadoPagoPlus_Client::post($uri, $data);
        return $result;
    }
    ...
    public function put($uri, $data, $params = null) {
        ...
        $result = Dc_MercadoPagoPlus_Client::put($uri, $data);
        return $result;
    }
    ...
    public function delete($uri, $params = null) {
        ...
        $result = Dc_MercadoPagoPlus_Client::delete($uri);
        return $result;
    }
